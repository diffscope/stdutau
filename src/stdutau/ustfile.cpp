...
namespace Utau {
    ...
    */
    ...
    /*!
        ...
        starts. The \c Version and \c settings sections are readonly and not needed in the return
        file, you can leave them empty when saving the file in your plugin.
    */
