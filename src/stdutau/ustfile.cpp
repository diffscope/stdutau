...
namespace Utau {
    ...
    */
    ...
    /*!
        \class PluginFile
        \brief Plugin temporary text file reader and writer.

        Use this class to read and write the \c .tmp file generated by UTAU when your plugin
        starts. the \c Version and \c settings sections are not needed in the return file, you can
        set these two fields to empty when saving the file in your plugin.
    */
    ...
    */
    ...
    /*!
        Reads \c ust sections from stream, returns \c true if succees.
    */
    bool PluginFile::read(std::istream &is) {
        return false;
    }
    ...
    /*!
        Writes \c ust sections to stream, returns \c true if succees.
    */
    bool PluginFile::write(std::ostream &os) const {
        return false;
    }
